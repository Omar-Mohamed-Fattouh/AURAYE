...
export default function AboutHero() {
  return (
    <section className="relative w-full bg-gradient-to-b from-black to-black/95 text-white overflow-hidden py-16 md:py-24">
      {/* Glow background & grid */}
      <div className="pointer-events-none absolute inset-0 opacity-40">
        <div className="absolute -top-40 -left-20 h-72 w-72 rounded-full bg-white/40 blur-3xl" />
        <div className="absolute -bottom-40 -right-10 h-72 w-72 rounded-full bg-white/20 blur-3xl" />
        <div className="h-full w-full bg-[radial-gradient(circle_at_top,_#ffffff22_0,_transparent_55%)]" />
      </div>

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Top text */}
        <div className="text-center mb-10 md:mb-16">
          <p className="inline-flex items-center gap-2 text-xs md:text-sm uppercase tracking-[0.2em] text-white/80 bg-white/5 border border-white/10 rounded-full px-4 py-1 mb-4">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-14">
            ...
            {leftCards.map((card, idx) => {
              ...
              return (
                <motion.div
                  ...
                  initial="initial"
                  animate="animate"
                  className="group flex items-start gap-4 rounded-2xl bg-white/5 border border-white/10 px-4 py-4 backdrop-blur-xl shadow-lg"
                >
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-white text-black shadow-lg group-hover:scale-105 transition-transform">
          ...
          <div className="relative flex-1 max-w-xl w-full">
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
              <div className="h-72 w-72 md:h-96 md:w-96 rounded-full bg-white/10 blur-3xl" />
            </div>
            ...
            <motion.div
              ...
              className="relative rounded-3xl overflow-hidden border border-white/10 shadow-xl bg-black/40 backdrop-blur-xl"
            >
              <img
                src="/VTOOO.jpg"
            ...
            {allCards.map((card, idx) => {
              ...
              return (
                <SwiperSlide key={`${card.title}-${idx}`}>
                  <div className="h-full rounded-2xl bg-white/10 border border-white/15 px-4 py-4 flex items-center gap-3 backdrop-blur-xl shadow-xl">
