    ...
    const loadSunProducts = async () => {
      try {
        ...
        const filtered = all.filter(
          (p) => String(p.category).toLowerCase() === "sunglasses"
        );
    ...
    return (
      <section className="py-16">
        <div className="container mx-auto px-6">
          <p className="text-center text-gray-500">Loading sunglasses...</p>
        </div>
      </section>
    );
  }
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mb-6 space-y-3">
          ...
          <p className="text-gray-600 text-sm md:text-base max-w-xl">
            Explore our sunglasses collection and protect your eyes with style.
            Use search and filters to find your perfect pair.
          </p>
        </div>
        ...
        <div className="mb-6 space-y-3">
          ...
          <div className="flex items-center">
            ...
            >
              ...
              <input
                type="text"
                placeholder="Search sunglasses by name..."
                value={searchTerm}
        ...
        <div className="mb-4 text-xs text-gray-500">
          Showing {filteredProducts.length} of {sunProducts.length} sunglasses
        </div>

        {/* Products grid */}
        {filteredProducts.length === 0 ? (
          <div className="mt-8 text-gray-500 text-sm">
            No sunglasses found. Try changing the search or filters.
          </div>
        ) : (
...
/** Small pill button component for filter chips */
